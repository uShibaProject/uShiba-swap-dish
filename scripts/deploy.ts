...
//change
const uShibaToken = '0xdf4c1992b2d1fb169652561a0c5943bfb18759f8'
const uShibaMaster = '0x1DC9e0e53F6Eb7b609297Ef7b453202425Af3C64'
const feeAddr = '0x1DC9e0e53F6Eb7b609297Ef7b453202425Af3C64'
...
async function approveuShibaMasterForSpendStakingPowerToken() {
    const DishMaster = await ethers.getContractFactory('DishMaster')
    const tx = await DishMaster.attach(dishMaster).approveuShibaMasterForSpendStakingPowerToken();
    console.log(`approveuShibaMasterForSpendStakingPowerToken ${tx.hash}`)
    await tx.wait()
}
...
async function main() {
     ...
     */
    // await deployContract('DishMaster', [dishStakingPowerToken, uShibaToken, dishNFT, uShibaMaster, feeAddr]);
    /**
    ...
    // await approveuShibaMasterForSpendStakingPowerToken();
    /**
     ...
     approveuShibaMasterForSpendStakingPowerToken 0x6c07e9468312dec93ab28c0883aabf47fdcff10a657f5f64f2cd946b333752c1
     */
    // await deployContract('ExchangeNFT', [ dishNFT, uShibaToken]);
    /**
